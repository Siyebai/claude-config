...
| Subject | Path |
|---------|------|
| Hypera/Cafehyna local cluster context (kubeconfig, port-forward, aliases) | `References/command-cafehyna.md` + `References/command-workflows/` + `References/command-tools/` |
