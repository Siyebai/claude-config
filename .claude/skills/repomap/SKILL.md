...
- **Enable**: `touch .repomap-auto` — REPOMAP.md incrementally updated on every file edit. REPOMAP.md must already exist first.
- **Disable**: `rm -f .repomap-auto` — REPOMAP.md kept as-is, manual update via `/repomap` still works.
