...
> 最后更新：2026-05-30 | 维护者：Codex + Claude Code
...
| **06** | **[Claude Code 新手部署指南](06-claude-code-beginner-guide.md)** | **Claude Code 从零安装、DeepSeek 对接、VS Code** | **⭐⭐⭐** |
| **07** | **[CCSwitch+DeepSeek 完整部署教程](07-ccswitch-deepseek-full-guide.md)** | **🔒 永久保留 — CCSwitch+DeepSeek 驱动 Codex & Claude Code 完整教程** | **⭐⭐⭐⭐⭐** |
...
| CCSwitch 配置 | `~/.ccswitch-deepseek/.env` |
